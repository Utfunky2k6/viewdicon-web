...
const ITEMS = [
  { name: 'Consultation Fee', status: 'paid', value: '₡15,000' },
  { name: 'Lab Tests', status: 'pending', value: '₡8,500' },
  { name: 'Medication', status: 'partial', value: '₡22,000' },
  { name: 'Surgery Fee', status: 'insurance', value: '₡350,000' },
]

const SC: Record<string,string> = {"paid":"#16a34a","pending":"#f59e0b","partial":"#f59e0b","insurance":"#3b82f6"}

export default function BillingTool() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💳 Billing Tool</h2>
