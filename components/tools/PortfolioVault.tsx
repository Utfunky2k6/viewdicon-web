...
const ITEMS = [
  { name: 'Stock: Dangote Cement', status: 'gain', value: '₡45,000 (+12%)' },
  { name: 'Bond: FGN 2030', status: 'stable', value: '₡200,000' },
  { name: 'Mutual Fund: ARM', status: 'gain', value: '₡80,000 (+5%)' },
  { name: 'Real Estate Fund', status: 'stable', value: '₡500,000' },
]
...
export default function PortfolioVault() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💼 Portfolio Vault</h2>
