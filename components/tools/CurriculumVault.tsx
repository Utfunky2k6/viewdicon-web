...
const ITEMS = [
  { name: 'Mathematics SS2 Syllabus', status: 'current', value: '2026 edition' },
  { name: 'English JSS3 Scheme of Work', status: 'current', value: 'Term 2' },
  { name: 'Physics Practical Manual', status: 'updated', value: 'v3.1' },
  { name: 'Biology Field Guide', status: 'draft', value: 'Under review' },
]

const SC: Record<string,string> = {"current":"#16a34a","updated":"#6b7280","draft":"#f59e0b"}
...
export default function CurriculumVault() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📚 Curriculum Vault</h2>
