...
const ITEMS = [
  { name: 'PT-201 Chioma A.', status: 'treating', value: 'P. falciparum' },
  { name: 'PT-202 Emeka O.', status: 'recovered', value: 'P. vivax' },
  { name: 'PT-203 Amina D.', status: 'testing', value: 'Suspected' },
  { name: 'PT-204 Kofi M.', status: 'treating', value: 'P. falciparum' },
]

const SC: Record<string,string> = {"treating":"#f59e0b","recovered":"#16a34a","testing":"#f59e0b"}

export default function MalariaCaseLog() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🦟 Malaria Case Log</h2>
