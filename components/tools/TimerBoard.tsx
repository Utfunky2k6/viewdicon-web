...
const ITEMS = [
  { name: 'Match - Quarter 1', status: 'running', value: '08:42' },
  { name: 'Match - Quarter 2', status: 'pending', value: '10:00' },
  { name: 'Half Time', status: 'pending', value: '15:00' },
  { name: 'Final Score', status: 'pending', value: '—' },
]

const SC: Record<string,string> = {"running":"#f59e0b","pending":"#f59e0b"}
...
export default function TimerBoard() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>⏱️ Timer Board</h2>
