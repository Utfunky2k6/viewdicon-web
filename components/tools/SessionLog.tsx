...
const ITEMS = [
  { name: 'Coaching - Amara O.', status: 'complete', value: '90 min' },
  { name: 'Mentoring - Kofi B.', status: 'complete', value: '60 min' },
  { name: 'Workshop - Group A', status: 'scheduled', value: 'Apr 8, 2hrs' },
  { name: 'Consultation - Emeka', status: 'cancelled', value: 'Rescheduled Apr 12' },
]

const SC: Record<string,string> = {"complete":"#16a34a","scheduled":"#3b82f6","cancelled":"#6b7280"}
...
export default function SessionLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📋 Session Log</h2>
