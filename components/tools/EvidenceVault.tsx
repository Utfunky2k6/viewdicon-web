...
const ITEMS = [
  { name: 'Case #EV-101 - Documents', status: 'sealed', value: '42 files' },
  { name: 'Case #EV-102 - Photos', status: 'catalogued', value: '128 items' },
  { name: 'Case #EV-103 - Recordings', status: 'processing', value: '8 audio files' },
  { name: 'Case #EV-104 - Digital', status: 'sealed', value: '1.2GB data' },
]

const SC: Record<string,string> = {"sealed":"#6366f1","catalogued":"#3b82f6","processing":"#f59e0b"}
...
export default function EvidenceVault() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🗄️ Evidence Vault</h2>
