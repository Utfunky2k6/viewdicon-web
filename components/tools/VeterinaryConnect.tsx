...
const ITEMS = [
  { name: 'Dr. Abiodun - Large Animal', status: 'available', value: 'Ogun State' },
  { name: 'Dr. Mensah - Poultry', status: 'busy', value: 'Next: Apr 9' },
  { name: 'Vet Clinic Ibadan', status: 'open', value: 'Walk-in OK' },
  { name: 'Mobile Vet - Kano Region', status: 'available', value: 'Call to book' },
]

const SC: Record<string,string> = {"available":"#16a34a","busy":"#f59e0b","open":"#16a34a"}

export default function VeterinaryConnect() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🐄 Veterinary Connect</h2>
