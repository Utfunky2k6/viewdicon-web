...
const ITEMS = [
  { name: 'Metformin 500mg', status: 'due', value: 'Refill by Apr 8' },
  { name: 'Lisinopril 10mg', status: 'ok', value: '30 days left' },
  { name: 'Atorvastatin 20mg', status: 'due', value: 'Refill by Apr 10' },
  { name: 'Amlodipine 5mg', status: 'ok', value: '45 days left' },
]

const SC: Record<string,string> = {"due":"#f59e0b","ok":"#16a34a"}
...
export default function RefillTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🔄 Refill Tracker</h2>
