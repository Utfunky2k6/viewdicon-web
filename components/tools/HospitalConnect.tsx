...
const ITEMS = [
  { name: 'LUTH - Bed available', status: 'available', value: 'ICU: 2 beds' },
  { name: 'FMC Abeokuta', status: 'full', value: 'ICU: 0 beds' },
  { name: 'UCH Ibadan', status: 'available', value: 'Ward: 5 beds' },
  { name: 'LASUTH', status: 'available', value: 'ICU: 1 bed' },
]

const SC: Record<string,string> = {"available":"#16a34a","full":"#ef4444"}
...
export default function HospitalConnect() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏨 Hospital Connect</h2>
