...
const ITEMS = [
  { name: 'Football Tournament', status: 'locked', value: '₡500,000' },
  { name: 'Coding Challenge', status: 'releasing', value: '₡150,000' },
  { name: 'Art Competition', status: 'locked', value: '₡75,000' },
  { name: 'Quiz Night Prize', status: 'released', value: '₡25,000' },
]

const SC: Record<string,string> = {"locked":"#6366f1","releasing":"#f59e0b","released":"#16a34a"}

export default function PrizeEscrow() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏆 Prize Escrow</h2>
