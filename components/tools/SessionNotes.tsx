...
const ITEMS = [
  { name: 'Counseling - Amara O.', status: 'complete', value: 'Anxiety management' },
  { name: 'Therapy - Emeka K.', status: 'in_progress', value: 'CBT session 4 of 8' },
  { name: 'Coaching - Fatima B.', status: 'scheduled', value: 'Career transition' },
  { name: 'Group Session - Youth', status: 'complete', value: 'Stress workshop' },
]

const SC: Record<string,string> = {"complete":"#16a34a","in_progress":"#f59e0b","scheduled":"#3b82f6"}
...
export default function SessionNotes() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📋 Session Notes</h2>
