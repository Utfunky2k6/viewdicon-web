...
const ITEMS = [
  { name: 'Batch #ST-101 (45 txns)', status: 'settled', value: '₡8.9M' },
  { name: 'Batch #ST-102 (22 txns)', status: 'processing', value: '₡3.4M' },
  { name: 'Batch #ST-103 (18 txns)', status: 'pending', value: '₡2.1M' },
  { name: 'Batch #ST-104 (30 txns)', status: 'failed', value: '₡5.6M - retry' },
]

const SC: Record<string,string> = {"settled":"#16a34a","processing":"#f59e0b","pending":"#f59e0b","failed":"#ef4444"}
...
export default function SettlementTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💸 Settlement Tracker</h2>
