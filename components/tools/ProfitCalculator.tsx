...
const ITEMS = [
  { name: 'Revenue', status: 'income', value: '₡580,000' },
  { name: 'COGS', status: 'expense', value: '₡210,000' },
  { name: 'Operating Costs', status: 'expense', value: '₡95,000' },
  { name: 'Net Profit', status: 'result', value: '₡275,000' },
]

const SC: Record<string,string> = {"income":"#16a34a","expense":"#ef4444","result":"#6b7280"}
...
export default function ProfitCalculator() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📊 Profit Calculator</h2>
