...
const ITEMS = [
  { name: 'FBC Result - PT-401', status: 'sent_sms', value: 'Apr 5, 14:00' },
  { name: 'HIV Screen - PT-405', status: 'pending_pickup', value: 'Available now' },
  { name: 'Pregnancy Test - PT-406', status: 'delivered', value: 'Apr 5, 10:00' },
  { name: 'X-Ray Report - PT-407', status: 'sent_email', value: 'Apr 5, 16:30' },
]

const SC: Record<string,string> = {"sent_sms":"#16a34a","pending_pickup":"#f59e0b","delivered":"#16a34a","sent_email":"#16a34a"}
...
export default function ResultDelivery() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📩 Result Delivery</h2>
