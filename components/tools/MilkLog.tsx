...
const ITEMS = [
  { name: 'Morning Yield - Pen A', status: 'recorded', value: '42 litres' },
  { name: 'Morning Yield - Pen B', status: 'recorded', value: '38 litres' },
  { name: 'Afternoon - Pen A', status: 'pending', value: 'Est. 35L' },
  { name: 'Quality Test', status: 'passed', value: 'Fat: 3.8%' },
]

const SC: Record<string,string> = {"recorded":"#16a34a","pending":"#f59e0b","passed":"#16a34a"}
...
export default function MilkLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🥛 Milk Log</h2>
