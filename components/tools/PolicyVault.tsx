...
const ITEMS = [
  { name: 'Data Protection Policy', status: 'active', value: 'v3.0 - Jan 2026' },
  { name: 'HR Employee Handbook', status: 'active', value: 'v5.2 - Mar 2026' },
  { name: 'Financial Controls', status: 'review', value: 'Annual review due' },
  { name: 'Safety & Health Policy', status: 'active', value: 'v2.1 - Feb 2026' },
]

const SC: Record<string,string> = {"active":"#16a34a","review":"#f59e0b"}
...
export default function PolicyVault() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📜 Policy Vault</h2>
