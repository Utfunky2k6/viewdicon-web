...
const ITEMS = [
  { name: 'Flat tire - VH-01 on 3rd MB', status: 'resolved', value: 'Apr 5, 14:00' },
  { name: 'Minor fender - TR-05', status: 'investigating', value: 'Apr 4' },
  { name: 'Fuel theft report - Depot', status: 'open', value: 'Apr 3' },
  { name: 'Brake warning - VH-02', status: 'resolved', value: 'Apr 2' },
]

const SC: Record<string,string> = {"resolved":"#16a34a","investigating":"#f59e0b","open":"#16a34a"}
...
export default function IncidentLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🚨 Incident Log</h2>
