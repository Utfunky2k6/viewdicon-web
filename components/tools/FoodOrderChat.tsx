...
const ITEMS = [
  { name: 'Jollof Rice x3', status: 'preparing', value: '₡2,400' },
  { name: 'Suya Platter', status: 'ready', value: '₡1,800' },
  { name: 'Pepper Soup', status: 'delivered', value: '₡900' },
  { name: 'Pounded Yam x2', status: 'preparing', value: '₡3,200' },
]

const SC: Record<string,string> = {"preparing":"#f59e0b","ready":"#16a34a","delivered":"#16a34a"}

export default function FoodOrderChat() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🍲 Food Order Chat</h2>
