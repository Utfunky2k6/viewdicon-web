...
const ITEMS = [
  { name: 'Container #CG-201', status: 'in_transit', value: 'Lagos → Accra' },
  { name: 'Bulk Cargo #CG-202', status: 'clearing', value: 'Apapa Port' },
  { name: 'Air Freight #CG-203', status: 'delivered', value: 'MMA → Kotoka' },
  { name: 'Container #CG-204', status: 'loading', value: 'Tin Can Island' },
]

const SC: Record<string,string> = {"in_transit":"#3b82f6","clearing":"#f59e0b","delivered":"#16a34a","loading":"#f59e0b"}

export default function CargoLog() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🚢 Cargo Log</h2>
