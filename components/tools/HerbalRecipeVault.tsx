...
const ITEMS = [
  { name: 'Bitter Leaf Tonic', status: 'verified', value: 'Digestive aid' },
  { name: 'Moringa Infusion', status: 'verified', value: 'Nutrition boost' },
  { name: 'Neem Oil Preparation', status: 'traditional', value: 'Skin care' },
  { name: 'Ginger-Turmeric Mix', status: 'verified', value: 'Anti-inflammatory' },
]

const SC: Record<string,string> = {"verified":"#16a34a","traditional":"#92400e"}

export default function HerbalRecipeVault() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🌿 Herbal Recipe Vault</h2>
