...
const ITEMS = [
  { name: 'Website Redesign - Amala Foods', status: 'active', value: 'Due Apr 15' },
  { name: 'Logo - Kente Fashions', status: 'draft', value: 'Due Apr 20' },
  { name: 'App Dev - Lagos Rides', status: 'review', value: 'Due May 1' },
  { name: 'Brand Guide - Sankofa', status: 'complete', value: 'Delivered' },
]

const SC: Record<string,string> = {"active":"#16a34a","draft":"#f59e0b","review":"#f59e0b","complete":"#16a34a"}
...
export default function ClientBrief() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📋 Client Brief</h2>
