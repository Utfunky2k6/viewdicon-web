...
const ITEMS = [
  { name: 'Malaria - Agege LGA', status: 'rising', value: '+23 cases this week' },
  { name: 'Cholera - Makoko', status: 'declining', value: '-8 cases this week' },
  { name: 'Lassa Fever - Ondo', status: 'stable', value: '2 cases this week' },
  { name: 'COVID-19 - Lagos', status: 'low', value: '5 cases this week' },
]

const SC: Record<string,string> = {"rising":"#f59e0b","declining":"#16a34a","stable":"#6b7280","low":"#ef4444"}
...
export default function DiseaseTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🦠 Disease Tracker</h2>
