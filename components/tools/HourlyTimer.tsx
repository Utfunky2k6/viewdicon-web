...
const ITEMS = [
  { name: 'Client Consultation', status: 'running', value: '2h 15m' },
  { name: 'Design Work', status: 'paused', value: '4h 30m' },
  { name: 'Code Review', status: 'stopped', value: '1h 45m' },
  { name: 'Admin Tasks', status: 'running', value: '0h 35m' },
]

const SC: Record<string,string> = {"running":"#f59e0b","paused":"#f59e0b","stopped":"#6b7280"}

export default function HourlyTimer() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>⏱️ Hourly Timer</h2>
