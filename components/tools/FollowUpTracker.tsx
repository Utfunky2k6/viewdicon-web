...
const ITEMS = [
  { name: 'PT-701 Post-Surgery Day 14', status: 'due_today', value: 'Call patient' },
  { name: 'PT-702 Lab Recheck', status: 'overdue', value: 'Was due Apr 3' },
  { name: 'PT-703 Medication Review', status: 'scheduled', value: 'Apr 10' },
  { name: 'PT-704 Wound Check', status: 'complete', value: 'Healing well' },
]

const SC: Record<string,string> = {"due_today":"#f59e0b","overdue":"#ef4444","scheduled":"#3b82f6","complete":"#16a34a"}
...
export default function FollowUpTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📞 Follow-Up Tracker</h2>
