...
const ITEMS = [
  { name: 'Breakfast - Ward A', status: 'served', value: 'Pap + Akara' },
  { name: 'Lunch - Ward B', status: 'preparing', value: 'Rice + Stew' },
  { name: 'Dinner - ICU', status: 'planned', value: 'Soft diet menu' },
  { name: 'Special Diet - PT-601', status: 'preparing', value: 'Diabetic meal' },
]

const SC: Record<string,string> = {"served":"#16a34a","preparing":"#f59e0b","planned":"#8b5cf6"}
...
export default function MealPlanner() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🍽️ Meal Planner</h2>
