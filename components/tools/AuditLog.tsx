...
const ITEMS = [
  { name: 'User login from new device', status: 'info', value: '14:23:01' },
  { name: 'Permission escalation', status: 'warning', value: '14:20:45' },
  { name: 'Bulk data export', status: 'info', value: '14:15:30' },
  { name: 'Failed login attempt x3', status: 'alert', value: '14:10:12' },
]

const SC: Record<string,string> = {"info":"#3b82f6","warning":"#f59e0b","alert":"#ef4444"}
...
export default function AuditLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📋 Audit Log</h2>
