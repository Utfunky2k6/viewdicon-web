...
const ITEMS = [
  { name: 'Software Engineer - Kofi A.', status: 'scheduled', value: 'Apr 8, 10:00' },
  { name: 'Designer - Amina B.', status: 'confirmed', value: 'Apr 8, 14:00' },
  { name: 'PM - Emeka C.', status: 'pending', value: 'Apr 9, 11:00' },
  { name: 'Analyst - Zara D.', status: 'complete', value: 'Apr 5, done' },
]

const SC: Record<string,string> = {"scheduled":"#3b82f6","confirmed":"#16a34a","pending":"#f59e0b","complete":"#16a34a"}
...
export default function InterviewScheduler() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📅 Interview Scheduler</h2>
