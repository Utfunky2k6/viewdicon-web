...
const ITEMS = [
  { name: 'Mile 12 Market - Lagos', status: 'open', value: 'Fresh produce' },
  { name: 'Dawanau Market - Kano', status: 'open', value: 'Grains hub' },
  { name: 'Onitsha Main - Anambra', status: 'open', value: 'General trade' },
  { name: 'Bodija Market - Ibadan', status: 'closed', value: 'Opens tomorrow' },
]

const SC: Record<string,string> = {"open":"#16a34a","closed":"#6b7280"}
...
export default function MarketConnect() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏪 Market Connect</h2>
