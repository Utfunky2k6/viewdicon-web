...
const ITEMS = [
  { name: 'Mama Ngozi Restaurant', status: 'active', value: '₡2.4M lifetime' },
  { name: 'Adeola Builders Ltd', status: 'active', value: '₡890K lifetime' },
  { name: 'Kwame Tech Solutions', status: 'inactive', value: '₡340K lifetime' },
  { name: 'Amina Fashion House', status: 'active', value: '₡1.2M lifetime' },
]

const SC: Record<string,string> = {"active":"#16a34a","inactive":"#6b7280"}
...
export default function CustomerList() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📇 Customer List</h2>
