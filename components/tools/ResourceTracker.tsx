...
const ITEMS = [
  { name: 'Cement (50kg bags)', status: 'adequate', value: '450 bags' },
  { name: 'Steel Rods (12mm)', status: 'low', value: '80 bundles' },
  { name: 'Sand (tonnes)', status: 'adequate', value: '25 tonnes' },
  { name: 'Blocks (9-inch)', status: 'ordered', value: '2,000 coming Apr 8' },
]

const SC: Record<string,string> = {"adequate":"#16a34a","low":"#ef4444","ordered":"#6b7280"}
...
export default function ResourceTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📦 Resource Tracker</h2>
