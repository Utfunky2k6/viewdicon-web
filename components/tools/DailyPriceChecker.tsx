...
const ITEMS = [
  { name: 'Maize (50kg)', status: 'up', value: '₡18,500 ↑3%' },
  { name: 'Rice (50kg)', status: 'stable', value: '₡42,000 →' },
  { name: 'Tomato (basket)', status: 'down', value: '₡8,200 ↓12%' },
  { name: 'Palm Oil (25L)', status: 'up', value: '₡28,000 ↑5%' },
]

const SC: Record<string,string> = {"up":"#16a34a","stable":"#6b7280","down":"#ef4444"}

export default function DailyPriceChecker() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💹 Daily Price Checker</h2>
