...
const ITEMS = [
  { name: 'Metformin 500mg', status: 'taken', value: 'Morning ✓' },
  { name: 'Lisinopril 10mg', status: 'due', value: 'Evening - due 18:00' },
  { name: 'Aspirin 75mg', status: 'taken', value: 'Morning ✓' },
  { name: 'Atorvastatin 20mg', status: 'missed', value: 'Last night missed' },
]

const SC: Record<string,string> = {"taken":"#16a34a","due":"#f59e0b","missed":"#ef4444"}
...
export default function MedicationTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💊 Medication Tracker</h2>
