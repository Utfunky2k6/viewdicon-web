...
const ITEMS = [
  { name: 'Cardiology Referral', status: 'sent', value: 'LUTH' },
  { name: 'Ortho Referral', status: 'draft', value: 'National Ortho' },
  { name: 'Dermatology Referral', status: 'accepted', value: 'Skin Clinic' },
  { name: 'Eye Referral', status: 'pending', value: 'Eye Centre' },
]

const SC: Record<string,string> = {"sent":"#16a34a","draft":"#f59e0b","accepted":"#16a34a","pending":"#f59e0b"}
...
export default function ReferralGenerator() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📨 Referral Generator</h2>
