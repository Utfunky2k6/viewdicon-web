...
const ITEMS = [
  { name: 'Cassava Yield Optimization', status: 'published', value: '2026 Q1' },
  { name: 'Malaria Vaccine Trial Data', status: 'ongoing', value: 'Phase 2' },
  { name: 'Solar Microgrid Feasibility', status: 'complete', value: 'Report ready' },
  { name: 'Microfinance Impact Study', status: 'review', value: 'Peer review' },
]

const SC: Record<string,string> = {"published":"#16a34a","ongoing":"#f59e0b","complete":"#16a34a","review":"#f59e0b"}
...
export default function ResearchVault() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🔬 Research Vault</h2>
