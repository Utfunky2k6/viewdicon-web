...
const ITEMS = [
  { name: 'JSS 3A - Mathematics', status: 'active', value: '42 students' },
  { name: 'SS 2B - Physics', status: 'active', value: '38 students' },
  { name: 'JSS 1C - English', status: 'active', value: '45 students' },
  { name: 'SS 3A - Chemistry', status: 'active', value: '35 students' },
]

const SC: Record<string,string> = {"active":"#16a34a"}
...
export default function ClassManager() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🎓 Class Manager</h2>
