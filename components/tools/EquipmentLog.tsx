...
const ITEMS = [
  { name: 'Projector #P-01', status: 'available', value: 'Room 3A' },
  { name: 'Generator 20KVA', status: 'running', value: 'Fuel: 60%' },
  { name: 'PA System #PA-02', status: 'maintenance', value: 'Speaker repair' },
  { name: 'Printer HP-LaserJet', status: 'available', value: 'Toner: 40%' },
]

const SC: Record<string,string> = {"available":"#16a34a","running":"#f59e0b","maintenance":"#f59e0b"}
...
export default function EquipmentLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🔧 Equipment Log</h2>
