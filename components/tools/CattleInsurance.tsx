...
const ITEMS = [
  { name: 'Policy #CI-201 - 45 Head', status: 'active', value: '₡2.1M covered' },
  { name: 'Policy #CI-202 - 20 Head', status: 'renewal_due', value: 'Expires Apr 30' },
  { name: 'Claim #CL-88 - 2 Lost', status: 'processing', value: '₡180,000' },
  { name: 'Policy #CI-203 - 100 Head', status: 'active', value: '₡4.5M covered' },
]

const SC: Record<string,string> = {"active":"#16a34a","renewal_due":"#f59e0b","processing":"#f59e0b"}

export default function CattleInsurance() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🐃 Cattle Insurance</h2>
