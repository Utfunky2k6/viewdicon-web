...
const ITEMS = [
  { name: 'Dr. Okonkwo - Checkup', status: 'confirmed', value: 'Apr 8, 09:00' },
  { name: 'Legal - Adeola & Co', status: 'pending', value: 'Apr 9, 14:00' },
  { name: 'Tax Filing Review', status: 'confirmed', value: 'Apr 10, 10:00' },
  { name: 'Dental - Dr. Mensah', status: 'rescheduled', value: 'Apr 12, 11:00' },
]

const SC: Record<string,string> = {"confirmed":"#16a34a","pending":"#f59e0b","rescheduled":"#f59e0b"}
...
export default function AppointmentSystem() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🗓️ Appointment System</h2>
