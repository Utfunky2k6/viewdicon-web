...
const ITEMS = [
  { name: 'Lagos Island Office', status: 'active', value: '6.4541° N' },
  { name: 'Accra Warehouse', status: 'active', value: '5.6037° N' },
  { name: 'Nairobi Hub', status: 'planned', value: '1.2921° S' },
  { name: 'Cape Town Store', status: 'active', value: '33.9249° S' },
]

const SC: Record<string,string> = {"active":"#16a34a","planned":"#8b5cf6"}
...
export default function MapTool() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📍 Map Tool</h2>
