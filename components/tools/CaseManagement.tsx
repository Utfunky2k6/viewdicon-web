...
const ITEMS = [
  { name: 'CASE-101 Child Welfare', status: 'active', value: 'Home visit due' },
  { name: 'CASE-102 Elder Care', status: 'monitoring', value: 'Weekly check' },
  { name: 'CASE-103 Rehab Support', status: 'active', value: 'Phase 2 of 4' },
  { name: 'CASE-104 Housing', status: 'resolved', value: 'Placed successfully' },
]

const SC: Record<string,string> = {"active":"#16a34a","monitoring":"#f59e0b","resolved":"#16a34a"}
...
export default function CaseManagement() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📂 Case Management</h2>
