...
const ITEMS = [
  { name: 'Completion Certificate', status: 'template', value: 'Auto-fill ready' },
  { name: 'Achievement Award', status: 'template', value: 'Custom design' },
  { name: 'Training Certificate', status: 'template', value: 'QR verified' },
  { name: 'Webinar Attendance', status: 'template', value: 'Digital only' },
]

const SC: Record<string,string> = {"template":"#6366f1"}
...
export default function CertificateGenerator() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏅 Certificate Generator</h2>
