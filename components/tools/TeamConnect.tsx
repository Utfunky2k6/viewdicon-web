...
const ITEMS = [
  { name: 'Amara Osei', status: 'online', value: 'Design Lead' },
  { name: 'Kofi Mensah', status: 'online', value: 'Backend Dev' },
  { name: 'Fatima Al-Hassan', status: 'away', value: 'PM' },
  { name: 'Chidi Eze', status: 'offline', value: 'QA Engineer' },
]

const SC: Record<string,string> = {"online":"#16a34a","away":"#f59e0b","offline":"#6b7280"}
...
export default function TeamConnect() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>👥 Team Connect</h2>
