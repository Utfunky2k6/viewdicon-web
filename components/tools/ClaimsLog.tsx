...
const ITEMS = [
  { name: 'Claim #CL-301 Vehicle', status: 'processing', value: '₡1.2M' },
  { name: 'Claim #CL-302 Health', status: 'approved', value: '₡350K' },
  { name: 'Claim #CL-303 Property', status: 'investigating', value: '₡5.8M' },
  { name: 'Claim #CL-304 Travel', status: 'paid', value: '₡180K' },
]

const SC: Record<string,string> = {"processing":"#f59e0b","approved":"#16a34a","investigating":"#f59e0b","paid":"#16a34a"}
...
export default function ClaimsLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📋 Claims Log</h2>
