...
const ITEMS = [
  { name: 'Knee Strengthening Set', status: 'active', value: '3x daily, 10 reps' },
  { name: 'Post-Surgery Walking', status: 'active', value: '15 min, 2x daily' },
  { name: 'Shoulder Mobility', status: 'paused', value: 'Resume Apr 10' },
  { name: 'Back Stretches', status: 'active', value: 'Morning routine' },
]

const SC: Record<string,string> = {"active":"#16a34a","paused":"#f59e0b"}
...
export default function ExerciseGuide() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏃 Exercise Guide</h2>
