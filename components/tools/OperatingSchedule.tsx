...
const ITEMS = [
  { name: 'Appendectomy - Theater 1', status: 'in_progress', value: '09:00-10:30' },
  { name: 'C-Section - Theater 2', status: 'scheduled', value: '11:00-12:00' },
  { name: 'Hernia Repair - Theater 1', status: 'scheduled', value: '13:00-14:30' },
  { name: 'Biopsy - Theater 3', status: 'complete', value: '07:30-08:15' },
]

const SC: Record<string,string> = {"in_progress":"#f59e0b","scheduled":"#3b82f6","complete":"#16a34a"}
...
export default function OperatingSchedule() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏥 Operating Schedule</h2>
