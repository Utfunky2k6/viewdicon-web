...
const ITEMS = [
  { name: 'Chest X-Ray - PT-501', status: 'uploaded', value: 'Apr 5' },
  { name: 'Ultrasound - PT-502', status: 'reviewed', value: 'Apr 4' },
  { name: 'MRI Brain - PT-503', status: 'pending_review', value: 'Apr 5' },
  { name: 'Wound Photo - PT-504', status: 'uploaded', value: 'Apr 3' },
]

const SC: Record<string,string> = {"uploaded":"#6b7280","reviewed":"#6b7280","pending_review":"#f59e0b"}
...
export default function ImageVault() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🖼️ Image Vault</h2>
