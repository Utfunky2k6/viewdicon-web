...
const ITEMS = [
  { name: 'Scan #PS-101', status: 'processed', value: '3 drugs identified' },
  { name: 'Scan #PS-102', status: 'reviewing', value: '2 drugs identified' },
  { name: 'Scan #PS-103', status: 'processed', value: '5 drugs identified' },
  { name: 'Scan #PS-104', status: 'failed', value: 'Retry needed' },
]

const SC: Record<string,string> = {"processed":"#6b7280","reviewing":"#f59e0b","failed":"#ef4444"}
...
export default function PrescriptionScanner() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📷 Prescription Scanner</h2>
