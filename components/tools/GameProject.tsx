...
const ITEMS = [
  { name: 'Anansi Runner - Mobile', status: 'dev', value: 'Alpha v0.3' },
  { name: 'AfroQuiz Trivia', status: 'testing', value: 'Beta v1.0' },
  { name: 'Village Builder Sim', status: 'concept', value: 'GDD draft' },
  { name: 'Drum Battle - Multiplayer', status: 'dev', value: 'Prototype' },
]

const SC: Record<string,string> = {"dev":"#8b5cf6","testing":"#f59e0b","concept":"#a78bfa"}
...
export default function GameProject() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🎮 Game Project</h2>
