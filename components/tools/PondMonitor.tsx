...
const ITEMS = [
  { name: 'Pond A - Tilapia', status: 'healthy', value: 'pH 7.2, O2 6.8mg/L' },
  { name: 'Pond B - Catfish', status: 'warning', value: 'pH 6.5, feed more' },
  { name: 'Pond C - Shrimp', status: 'healthy', value: 'Salinity 15ppt' },
  { name: 'Hatchery Tank', status: 'breeding', value: '2,000 fingerlings' },
]

const SC: Record<string,string> = {"healthy":"#16a34a","warning":"#f59e0b","breeding":"#f59e0b"}
...
export default function PondMonitor() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🐠 Pond Monitor</h2>
