...
const ITEMS = [
  { name: 'Cassava Export Deal', status: 'negotiating', value: '₡45,000' },
  { name: 'Palm Oil Forward', status: 'agreed', value: '₡120,000' },
  { name: 'Shea Butter Contract', status: 'pending', value: '₡28,000' },
  { name: 'Cocoa Spot Trade', status: 'complete', value: '₡89,000' },
]

const SC: Record<string,string> = {"negotiating":"#f59e0b","agreed":"#16a34a","pending":"#f59e0b","complete":"#16a34a"}

export default function TradeSession() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🤝 Trade Session</h2>
