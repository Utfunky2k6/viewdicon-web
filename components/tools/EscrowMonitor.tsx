...
const ITEMS = [
  { name: 'ESC-401 Land Purchase', status: 'locked', value: '₡15M' },
  { name: 'ESC-402 Vehicle Sale', status: 'releasing', value: '₡2.8M' },
  { name: 'ESC-403 Service Contract', status: 'locked', value: '₡450K' },
  { name: 'ESC-404 Bulk Order', status: 'released', value: '₡1.2M' },
]
...
export default function EscrowMonitor() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🔐 Escrow Monitor</h2>
