...
const ITEMS = [
  { name: 'How to Reset Password', status: 'published', value: '1,234 views' },
  { name: 'API Authentication Guide', status: 'published', value: '892 views' },
  { name: 'Village Application Process', status: 'draft', value: 'Under review' },
  { name: 'Cowrie Earning Guide', status: 'published', value: '2,456 views' },
]

const SC: Record<string,string> = {"published":"#16a34a","draft":"#f59e0b"}
...
export default function KnowledgeBase() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📖 Knowledge Base</h2>
