...
const ITEMS = [
  { name: 'Total Active Members', status: 'stat', value: '1,247' },
  { name: 'New This Month', status: 'stat', value: '+38' },
  { name: 'Renewal Due', status: 'warning', value: '52 members' },
  { name: 'Lapsed (>90 days)', status: 'alert', value: '15 members' },
]

const SC: Record<string,string> = {"stat":"#6366f1","warning":"#f59e0b","alert":"#ef4444"}
...
export default function MemberTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>👥 Member Tracker</h2>
