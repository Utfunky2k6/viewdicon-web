...
const ITEMS = [
  { name: 'Chloroquine Recall Batch #CQ-445', status: 'urgent', value: 'Return stock' },
  { name: 'New ACT Protocol Update', status: 'info', value: 'Effective May 1' },
  { name: 'Counterfeit Alert - Augmentin', status: 'warning', value: 'Verify hologram' },
  { name: 'Price Cap - Essential Drugs', status: 'info', value: 'Effective Apr 15' },
]

const SC: Record<string,string> = {"urgent":"#ef4444","info":"#3b82f6","warning":"#f59e0b"}

export default function DrugAdvisory() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📢 Drug Advisory</h2>
