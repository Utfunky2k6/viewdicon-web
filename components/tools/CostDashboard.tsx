...
const ITEMS = [
  { name: 'Staff Costs', status: 'on_budget', value: '₡4.2M / ₡4.5M' },
  { name: 'Operations', status: 'over_budget', value: '₡1.8M / ₡1.5M' },
  { name: 'Marketing', status: 'under_budget', value: '₡320K / ₡500K' },
  { name: 'Infrastructure', status: 'on_budget', value: '₡2.1M / ₡2.2M' },
]

const SC: Record<string,string> = {"on_budget":"#16a34a","over_budget":"#ef4444","under_budget":"#3b82f6"}
...
export default function CostDashboard() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💵 Cost Dashboard</h2>
