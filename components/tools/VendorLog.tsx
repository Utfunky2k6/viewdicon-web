...
const ITEMS = [
  { name: 'Dangote Industries', status: 'active', value: 'Cement supplier' },
  { name: 'BUA Foods', status: 'active', value: 'Sugar/Rice' },
  { name: 'Innoson Motors', status: 'approved', value: 'Vehicle fleet' },
  { name: 'Mikano Int\'l', status: 'active', value: 'Generators' },
]

const SC: Record<string,string> = {"active":"#16a34a","approved":"#16a34a"}
...
export default function VendorLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏢 Vendor Log</h2>
