...
const ITEMS = [
  { name: 'Education Fund Drive', status: 'active', value: '₡2.8M / ₡5M goal' },
  { name: 'Flood Relief - Delta', status: 'complete', value: '₡8.2M raised' },
  { name: 'Healthcare Outreach', status: 'active', value: '₡450K / ₡1M goal' },
  { name: 'School Building Fund', status: 'active', value: '₡6.1M / ₡10M goal' },
]

const SC: Record<string,string> = {"active":"#16a34a","complete":"#16a34a"}
...
export default function DonationTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🎁 Donation Tracker</h2>
