...
const ITEMS = [
  { name: 'Block A - Foundation', status: 'complete', value: '100%' },
  { name: 'Block B - Structure', status: 'in_progress', value: '65%' },
  { name: 'Block C - Planning', status: 'pending', value: '0%' },
  { name: 'Access Road', status: 'in_progress', value: '40%' },
]

const SC: Record<string,string> = {"complete":"#16a34a","in_progress":"#f59e0b","pending":"#f59e0b"}
...
export default function SiteMap() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏗️ Site Map</h2>
