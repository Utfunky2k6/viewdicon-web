...
const ITEMS = [
  { name: 'Today Revenue', status: 'income', value: '₡185,000' },
  { name: 'Today Expenses', status: 'expense', value: '₡72,000' },
  { name: 'Net Profit', status: 'profit', value: '₡113,000' },
  { name: 'MTD Net Profit', status: 'profit', value: '₡1,240,000' },
]

const SC: Record<string,string> = {"income":"#16a34a","expense":"#ef4444","profit":"#16a34a"}
...
export default function DailyPnl() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💰 Daily P&L</h2>
