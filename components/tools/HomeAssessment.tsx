...
const ITEMS = [
  { name: 'Fall Risk Assessment', status: 'complete', value: 'Medium risk' },
  { name: 'Mobility Check', status: 'complete', value: 'Walker needed' },
  { name: 'Medication Storage', status: 'flagged', value: 'Needs lockbox' },
  { name: 'Sanitation Check', status: 'complete', value: 'Adequate' },
]

const SC: Record<string,string> = {"complete":"#16a34a","flagged":"#ef4444"}
...
export default function HomeAssessment() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏠 Home Assessment</h2>
