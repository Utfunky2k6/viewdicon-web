...
const ITEMS = [
  { name: 'ERR: DB connection timeout', status: 'error', value: 'auth-core 14:23' },
  { name: 'WARN: Rate limit near threshold', status: 'warning', value: 'gateway 14:20' },
  { name: 'INFO: Deploy v2.4.1 complete', status: 'info', value: '14:15' },
  { name: 'ERR: Redis ECONNREFUSED', status: 'error', value: 'honor 14:10' },
]

const SC: Record<string,string> = {"error":"#ef4444","warning":"#f59e0b","info":"#3b82f6"}
...
export default function DebugLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🐛 Debug Log</h2>
