...
const ITEMS = [
  { name: 'Cassava Flour - 500kg', status: 'complete', value: 'Apr 5' },
  { name: 'Palm Oil - 200L', status: 'processing', value: '60% done' },
  { name: 'Shea Butter - 100kg', status: 'complete', value: 'Apr 4' },
  { name: 'Garri - 300kg', status: 'drying', value: 'Ready tomorrow' },
]

const SC: Record<string,string> = {"complete":"#16a34a","processing":"#f59e0b","drying":"#6b7280"}
...
export default function ProductionLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📊 Production Log</h2>
