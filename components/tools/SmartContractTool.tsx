...
const ITEMS = [
  { name: 'Escrow Contract #0x4a...', status: 'deployed', value: '₡250,000' },
  { name: 'Token Vesting #0x7b...', status: 'active', value: '₡1.2M' },
  { name: 'DAO Vote #0x2c...', status: 'pending', value: '—' },
  { name: 'NFT Mint #0x9f...', status: 'complete', value: '500 minted' },
]

const SC: Record<string,string> = {"deployed":"#6b7280","active":"#16a34a","pending":"#f59e0b","complete":"#16a34a"}

export default function SmartContractTool() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>⛓️ Smart Contract Tool</h2>
