...
const ITEMS = [
  { name: 'Record #MR-001 - Chioma A.', status: 'current', value: 'Last: Apr 5' },
  { name: 'Record #MR-002 - Emeka O.', status: 'current', value: 'Last: Mar 28' },
  { name: 'Record #MR-003 - Fatima D.', status: 'archived', value: 'Transferred' },
  { name: 'Record #MR-004 - Kofi M.', status: 'current', value: 'Last: Apr 2' },
]

const SC: Record<string,string> = {"current":"#16a34a","archived":"#6b7280"}
...
export default function MedicalRecords() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🏥 Medical Records</h2>
