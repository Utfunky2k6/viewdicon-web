...
const ITEMS = [
  { name: 'Total Portfolio Value', status: 'gain', value: '₡2.4M (+8.3%)' },
  { name: 'Equities Allocation', status: 'stable', value: '₡1.2M (50%)' },
  { name: 'Fixed Income', status: 'stable', value: '₡720K (30%)' },
  { name: 'Alternative Assets', status: 'gain', value: '₡480K (20%)' },
]

const SC: Record<string,string> = {"gain":"#16a34a","stable":"#6b7280"}
...
export default function PortfolioTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📈 Portfolio Tracker</h2>
