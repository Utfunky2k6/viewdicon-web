...
const ITEMS = [
  { name: 'Plot A - Ikeja GRA', status: 'surveyed', value: '450 sqm' },
  { name: 'Plot B - Lekki Phase 2', status: 'pending', value: '800 sqm' },
  { name: 'Farm Land - Ogun', status: 'verified', value: '5 hectares' },
  { name: 'Commercial - VI', status: 'disputed', value: '1,200 sqm' },
]

const SC: Record<string,string> = {"surveyed":"#16a34a","pending":"#f59e0b","verified":"#16a34a","disputed":"#ef4444"}

export default function LandMapTool() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🗺️ Land Map Tool</h2>
