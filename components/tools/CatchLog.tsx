...
const ITEMS = [
  { name: 'Trip #F-201 - Atlantic', status: 'landed', value: '320kg mixed' },
  { name: 'Trip #F-202 - River', status: 'in_progress', value: 'Est. 150kg' },
  { name: 'Trip #F-203 - Lagoon', status: 'landed', value: '85kg shrimp' },
  { name: 'Trip #F-204 - Deep sea', status: 'planned', value: 'Tomorrow 5AM' },
]

const SC: Record<string,string> = {"landed":"#16a34a","in_progress":"#f59e0b","planned":"#8b5cf6"}
...
export default function CatchLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🐟 Catch Log</h2>
