...
const ITEMS = [
  { name: 'Warfarin + Aspirin', status: 'severe', value: 'Bleeding risk ↑' },
  { name: 'Metformin + Alcohol', status: 'moderate', value: 'Lactic acidosis' },
  { name: 'Lisinopril + Potassium', status: 'moderate', value: 'Hyperkalemia' },
  { name: 'Amoxicillin + OCP', status: 'mild', value: 'Reduced efficacy' },
]

const SC: Record<string,string> = {"severe":"#ef4444","moderate":"#ea580c","mild":"#3b82f6"}
...
export default function DrugInteractionChecker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>⚠️ Drug Interaction Checker</h2>
