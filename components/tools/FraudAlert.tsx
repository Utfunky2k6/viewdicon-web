...
const ITEMS = [
  { name: 'Unusual login pattern', status: 'high', value: 'Account #A-2041' },
  { name: 'Large transfer flagged', status: 'medium', value: '₡2.5M to new payee' },
  { name: 'Multiple OTP failures', status: 'high', value: 'Phone +234..8901' },
  { name: 'Duplicate transaction', status: 'low', value: '₡15K same payee x3' },
]

const SC: Record<string,string> = {"high":"#ef4444","medium":"#f59e0b","low":"#ef4444"}
...
export default function FraudAlert() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🚫 Fraud Alert</h2>
