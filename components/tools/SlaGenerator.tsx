...
const ITEMS = [
  { name: 'Cloud Hosting SLA', status: 'active', value: '99.9% uptime' },
  { name: 'Support SLA - Gold', status: 'active', value: '4hr response' },
  { name: 'Delivery SLA', status: 'draft', value: '48hr delivery' },
  { name: 'API Availability SLA', status: 'template', value: '99.95% uptime' },
]

const SC: Record<string,string> = {"active":"#16a34a","draft":"#f59e0b","template":"#6366f1"}
...
export default function SlaGenerator() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📄 SLA Generator</h2>
