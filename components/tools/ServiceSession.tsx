...
const ITEMS = [
  { name: 'AC Repair - Flat 4B', status: 'in_progress', value: '₡12,000' },
  { name: 'Plumbing Fix', status: 'scheduled', value: '₡8,000' },
  { name: 'Electrical Rewire', status: 'quoted', value: '₡45,000' },
  { name: 'Generator Service', status: 'complete', value: '₡15,000' },
]

const SC: Record<string,string> = {"in_progress":"#f59e0b","scheduled":"#3b82f6","quoted":"#6b7280","complete":"#16a34a"}
...
export default function ServiceSession() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🔧 Service Session</h2>
