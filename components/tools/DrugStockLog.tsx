...
const ITEMS = [
  { name: 'Artemether 80mg', status: 'adequate', value: '450 units' },
  { name: 'Paracetamol 500mg', status: 'low', value: '89 units' },
  { name: 'Amoxicillin 250mg', status: 'adequate', value: '320 units' },
  { name: 'ORS Sachets', status: 'critical', value: '12 units' },
]

const SC: Record<string,string> = {"adequate":"#16a34a","low":"#ef4444","critical":"#ef4444"}

export default function DrugStockLog() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💊 Drug Stock Log</h2>
