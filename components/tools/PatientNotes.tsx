...
const ITEMS = [
  { name: 'PT-301 - Follow-up visit', status: 'today', value: 'BP stable, continue meds' },
  { name: 'PT-302 - New complaint', status: 'today', value: 'Headache 3 days, refer neuro' },
  { name: 'PT-303 - Lab results review', status: 'yesterday', value: 'HbA1c improved to 6.8' },
  { name: 'PT-304 - Discharge summary', status: 'yesterday', value: 'Post-op day 5, healing well' },
]

const SC: Record<string,string> = {"today":"#6b7280","yesterday":"#6b7280"}
...
export default function PatientNotes() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📝 Patient Notes</h2>
