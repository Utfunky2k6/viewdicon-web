...
const ITEMS = [
  ...
  { name: 'Blood Sugar', status: 'normal', value: '5.4 mmol/L' },
  { name: 'Weight', status: 'recorded', value: '78 kg' },
  { name: 'Steps Today', status: 'in_progress', value: '6,420 / 10,000' },
]

const SC: Record<string,string> = {"normal":"#16a34a","recorded":"#16a34a","in_progress":"#f59e0b"}
...
export default function HealthLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>❤️ Health Log</h2>
