...
const ITEMS = [
  { name: 'Blood Sample #SL-701', status: 'processing', value: 'Hematology' },
  { name: 'Urine Sample #SL-702', status: 'received', value: 'Biochemistry' },
  { name: 'Swab #SL-703', status: 'culturing', value: 'Microbiology' },
  { name: 'Tissue #SL-704', status: 'transported', value: 'Histopathology' },
]

const SC: Record<string,string> = {"processing":"#f59e0b","received":"#3b82f6","culturing":"#f59e0b","transported":"#3b82f6"}

export default function SampleLog() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🧫 Sample Log</h2>
