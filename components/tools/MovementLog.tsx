...
const ITEMS = [
  { name: 'Herd #H-01 → Kaduna', status: 'in_transit', value: '45 cattle' },
  { name: 'Flock #F-03 → Market', status: 'arrived', value: '200 poultry' },
  { name: 'Herd #H-02 → Grazing', status: 'returned', value: '38 cattle' },
  { name: 'Fish Batch → Cold Store', status: 'in_transit', value: '500kg tilapia' },
]

const SC: Record<string,string> = {"in_transit":"#3b82f6","arrived":"#6b7280","returned":"#6b7280"}
...
export default function MovementLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🚛 Movement Log</h2>
