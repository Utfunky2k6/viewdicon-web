...
const ITEMS = [
  { name: 'Ogun Farmers Coop', status: 'member', value: '1,200 members' },
  { name: 'Northern Grain Alliance', status: 'pending', value: 'Application sent' },
  { name: 'Cocoa Producers Union', status: 'member', value: '800 members' },
  { name: 'Fish Farmers Network', status: 'invited', value: 'Join by Apr 15' },
]

const SC: Record<string,string> = {"member":"#16a34a","pending":"#f59e0b","invited":"#8b5cf6"}

export default function CooperativeConnect() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🤝 Cooperative Connect</h2>
