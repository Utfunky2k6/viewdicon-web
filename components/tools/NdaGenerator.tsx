...
const ITEMS = [
  { name: 'Mutual NDA - Tech Partner', status: 'signed', value: '12 months' },
  { name: 'One-way NDA - Freelancer', status: 'pending', value: '24 months' },
  { name: 'Investment NDA', status: 'draft', value: '36 months' },
  { name: 'Employee NDA Template', status: 'template', value: 'Perpetual' },
]

const SC: Record<string,string> = {"signed":"#16a34a","pending":"#f59e0b","draft":"#f59e0b","template":"#6366f1"}
...
export default function NdaGenerator() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📝 NDA Generator</h2>
