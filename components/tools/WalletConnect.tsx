...
const ITEMS = [
  { name: 'Cowrie Wallet', status: 'connected', value: '₡12,450' },
  { name: 'UnionPay Account', status: 'connected', value: '₡89,300' },
  { name: 'Mobile Money', status: 'pending', value: '—' },
  { name: 'Blockchain Wallet', status: 'connected', value: '0.45 ETH' },
]

const SC: Record<string,string> = {"connected":"#16a34a","pending":"#f59e0b"}
...
export default function WalletConnect() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💰 Wallet Connect</h2>
