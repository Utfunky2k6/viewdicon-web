...
const ITEMS = [
  { name: 'Apr 5 - Lagos', status: 'recorded', value: '32°C, 78% humidity' },
  { name: 'Apr 4 - Lagos', status: 'recorded', value: '30°C, Rain 12mm' },
  { name: 'Apr 3 - Lagos', status: 'recorded', value: '31°C, Partly cloudy' },
  { name: 'Apr 2 - Lagos', status: 'recorded', value: '33°C, Clear' },
]

const SC: Record<string,string> = {"recorded":"#16a34a"}
...
export default function WeatherLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🌤️ Weather Log</h2>
