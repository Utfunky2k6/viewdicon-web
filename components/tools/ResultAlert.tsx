...
const ITEMS = [
  { name: 'CRITICAL: PT-401 Hemoglobin 5.2', status: 'critical', value: 'Transfusion needed' },
  { name: 'ABNORMAL: PT-402 WBC 18,000', status: 'abnormal', value: 'Infection likely' },
  { name: 'CRITICAL: PT-403 Potassium 6.8', status: 'critical', value: 'Urgent review' },
  { name: 'NORMAL: PT-404 All within range', status: 'normal', value: 'No action needed' },
]

const SC: Record<string,string> = {"critical":"#ef4444","abnormal":"#f59e0b","normal":"#16a34a"}
...
export default function ResultAlert() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🚨 Result Alert</h2>
