...
const ITEMS = [
  { name: 'Toyota Hiace #VH-01', status: 'active', value: 'Lagos-Ibadan route' },
  { name: 'Bajaj RE #TR-05', status: 'maintenance', value: 'Oil change due' },
  { name: 'Mercedes Sprinter #VH-02', status: 'active', value: 'Airport shuttle' },
  { name: 'Honda CRV #SV-03', status: 'idle', value: 'Available' },
]

const SC: Record<string,string> = {"active":"#16a34a","maintenance":"#f59e0b","idle":"#6b7280"}
...
export default function FleetManager() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🚗 Fleet Manager</h2>
