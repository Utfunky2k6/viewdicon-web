...
const ITEMS = [
  { name: 'Payment Not Received', status: 'investigating', value: '₡15,000' },
  { name: 'Wrong Item Delivered', status: 'resolved', value: '₡3,200' },
  { name: 'Late Shipment Claim', status: 'pending', value: '₡8,500' },
  { name: 'Quality Complaint', status: 'escalated', value: '₡22,000' },
]

const SC: Record<string,string> = {"investigating":"#f59e0b","resolved":"#16a34a","pending":"#f59e0b","escalated":"#6b7280"}
...
export default function DisputeResolver() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>⚖️ Dispute Resolver</h2>
