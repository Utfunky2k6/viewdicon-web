...
const ITEMS = [
  { name: 'Batch #IB-04 (15 invoices)', status: 'processing', value: '₡2.3M total' },
  { name: 'Batch #IB-03 (8 invoices)', status: 'sent', value: '₡890K total' },
  { name: 'Batch #IB-02 (22 invoices)', status: 'paid', value: '₡4.1M total' },
  { name: 'Batch #IB-01 (10 invoices)', status: 'overdue', value: '₡1.5M total' },
]

const SC: Record<string,string> = {"processing":"#f59e0b","sent":"#16a34a","paid":"#16a34a","overdue":"#ef4444"}

export default function InvoiceBatch() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📑 Invoice Batch</h2>
