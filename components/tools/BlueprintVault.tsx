...
const ITEMS = [
  { name: '3-Bed Bungalow Plan', status: 'approved', value: 'v2.0 final' },
  { name: 'Commercial Plaza Design', status: 'review', value: 'Structural pending' },
  { name: 'School Building - Phase 1', status: 'approved', value: 'Construction ready' },
  { name: 'Bridge Reinforcement', status: 'draft', value: 'Engineering review' },
]

const SC: Record<string,string> = {"approved":"#16a34a","review":"#f59e0b","draft":"#f59e0b"}
...
export default function BlueprintVault() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📐 Blueprint Vault</h2>
