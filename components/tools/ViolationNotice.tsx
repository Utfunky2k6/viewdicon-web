...
const ITEMS = [
  { name: 'Improper Waste Segregation', status: 'issued', value: 'Fine: ₡50,000' },
  { name: 'Expired Fire Extinguisher', status: 'resolved', value: 'Replaced' },
  { name: 'Missing Safety Signage', status: 'pending', value: '7 days to comply' },
  { name: 'Overcrowded Ward', status: 'issued', value: 'Warning #2' },
]

const SC: Record<string,string> = {"issued":"#ef4444","resolved":"#16a34a","pending":"#f59e0b"}
...
export default function ViolationNotice() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>⛔ Violation Notice</h2>
