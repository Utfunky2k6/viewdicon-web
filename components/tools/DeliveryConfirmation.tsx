...
const ITEMS = [
  { name: 'ORD-4521 to Ikeja', status: 'delivered', value: 'Apr 5, 14:30' },
  { name: 'ORD-4522 to Lekki', status: 'in_transit', value: 'ETA 16:00' },
  { name: 'ORD-4523 to Surulere', status: 'delivered', value: 'Apr 5, 11:15' },
  { name: 'ORD-4524 to VI', status: 'pending', value: 'Pickup tomorrow' },
]

const SC: Record<string,string> = {"delivered":"#16a34a","in_transit":"#3b82f6","pending":"#f59e0b"}
...
export default function DeliveryConfirmation() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>✅ Delivery Confirmation</h2>
