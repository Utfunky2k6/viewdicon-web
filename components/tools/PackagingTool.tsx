...
const ITEMS = [
  { name: 'Rice 5kg Bag', status: 'in_stock', value: '2,000 bags @ ₡45' },
  { name: 'Produce Crate', status: 'low', value: '150 @ ₡350' },
  { name: 'Vacuum Seal Kit', status: 'in_stock', value: '800 @ ₡120' },
  { name: 'Export Carton', status: 'order', value: 'Need 500 more' },
]

const SC: Record<string,string> = {"in_stock":"#16a34a","low":"#ef4444","order":"#f59e0b"}

export default function PackagingTool() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📦 Packaging Tool</h2>
