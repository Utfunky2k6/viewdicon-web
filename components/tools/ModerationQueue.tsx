...
const ITEMS = [
  { name: 'Post #P-891 - Flagged spam', status: 'pending', value: '3 reports' },
  { name: 'Comment #C-2041 - Hate speech', status: 'urgent', value: '7 reports' },
  { name: 'Profile #U-445 - Fake account', status: 'reviewing', value: '2 reports' },
  { name: 'Image #I-120 - Inappropriate', status: 'pending', value: '5 reports' },
]

const SC: Record<string,string> = {"pending":"#f59e0b","urgent":"#ef4444","reviewing":"#f59e0b"}
...
export default function ModerationQueue() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🛡️ Moderation Queue</h2>
