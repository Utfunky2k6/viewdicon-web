...
const ITEMS = [
  { name: 'From Dr. Ade - Cardiac case', status: 'new', value: 'Urgent' },
  { name: 'From PHC Agege - Diabetes', status: 'reviewed', value: 'Routine' },
  { name: 'From Dr. Kwame - Surgery', status: 'accepted', value: 'Urgent' },
  { name: 'From Clinic Lekki - Skin', status: 'pending', value: 'Routine' },
]

const SC: Record<string,string> = {"new":"#2563eb","reviewed":"#6b7280","accepted":"#16a34a","pending":"#f59e0b"}
...
export default function ReferralInbox() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📥 Referral Inbox</h2>
