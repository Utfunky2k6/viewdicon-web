...
const ITEMS = [
  { name: 'Ibrahim Musa - Grains', status: 'online', value: 'Kano' },
  { name: 'Grace Olu - Vegetables', status: 'online', value: 'Oyo' },
  { name: 'Abdul Karimu - Livestock', status: 'offline', value: 'Sokoto' },
  { name: 'Ngozi Ibe - Cassava', status: 'online', value: 'Enugu' },
]

const SC: Record<string,string> = {"online":"#16a34a","offline":"#6b7280"}
...
export default function FarmerConnect() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>👨‍🌾 Farmer Connect</h2>
