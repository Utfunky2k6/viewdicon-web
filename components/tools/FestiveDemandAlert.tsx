...
const ITEMS = [
  { name: 'Eid al-Fitr (Apr 10)', status: 'high_demand', value: 'Ram ↑40%, Rice ↑15%' },
  { name: 'Easter Weekend', status: 'moderate', value: 'Poultry ↑25%' },
  { name: 'Christmas Season', status: 'upcoming', value: 'Start stocking Nov' },
  { name: 'New Yam Festival', status: 'upcoming', value: 'Yam ↑30% expected' },
]

const SC: Record<string,string> = {"high_demand":"#ef4444","moderate":"#ea580c","upcoming":"#8b5cf6"}

export default function FestiveDemandAlert() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🎉 Festive Demand Alert</h2>
