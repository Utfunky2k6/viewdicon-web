...
const ITEMS = [
  { name: 'Monthly HMIS Report', status: 'due', value: 'Due Apr 10' },
  { name: 'Disease Surveillance Weekly', status: 'submitted', value: 'Apr 4' },
  { name: 'Maternal Health Quarterly', status: 'draft', value: 'Due Apr 30' },
  { name: 'Immunization Coverage', status: 'submitted', value: 'Apr 1' },
]

const SC: Record<string,string> = {"due":"#f59e0b","submitted":"#16a34a","draft":"#f59e0b"}

export default function DataReporter() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📊 Data Reporter</h2>
