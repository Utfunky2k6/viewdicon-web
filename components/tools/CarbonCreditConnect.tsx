...
const ITEMS = [
  { name: 'Reforestation Project A', status: 'verified', value: '120 tCO2/yr' },
  { name: 'Solar Farm Credit', status: 'pending', value: '80 tCO2/yr' },
  { name: 'Cookstove Distribution', status: 'verified', value: '200 tCO2/yr' },
  { name: 'Mangrove Restoration', status: 'monitoring', value: '50 tCO2/yr' },
]

const SC: Record<string,string> = {"verified":"#16a34a","pending":"#f59e0b","monitoring":"#f59e0b"}

export default function CarbonCreditConnect() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🌱 Carbon Credit Connect</h2>
