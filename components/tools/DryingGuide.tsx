...
const ITEMS = [
  { name: 'Solar Drying - Tomatoes', status: 'recommended', value: '3-5 days' },
  { name: 'Rack Drying - Cassava', status: 'in_progress', value: '2-3 days' },
  { name: 'Tunnel Dryer - Peppers', status: 'recommended', value: '1-2 days' },
  { name: 'Air Drying - Maize', status: 'traditional', value: '5-7 days' },
]

const SC: Record<string,string> = {"recommended":"#16a34a","in_progress":"#f59e0b","traditional":"#92400e"}

export default function DryingGuide() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>☀️ Drying Guide</h2>
