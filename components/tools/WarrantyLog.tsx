...
const ITEMS = [
  { name: 'Generator - Mikano 20KVA', status: 'active', value: 'Expires Dec 2026' },
  { name: 'Laptop - HP Pavilion', status: 'active', value: 'Expires Aug 2027' },
  { name: 'AC Unit - LG Split', status: 'expired', value: 'Expired Feb 2026' },
  { name: 'Solar Panel - Lumos', status: 'active', value: 'Expires 2036' },
]

const SC: Record<string,string> = {"active":"#16a34a","expired":"#6b7280"}

export default function WarrantyLog() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🛡️ Warranty Log</h2>
