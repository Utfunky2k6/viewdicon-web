...
const ITEMS = [
  { name: 'Maize - Western Region', status: 'ready', value: 'Harvest Jul-Aug' },
  { name: 'Cassava - South', status: 'growing', value: 'Harvest Jan-Feb' },
  { name: 'Sorghum - North', status: 'planting', value: 'Harvest Oct' },
  { name: 'Cocoa - Ondo', status: 'flowering', value: 'Harvest Nov-Dec' },
]

const SC: Record<string,string> = {"ready":"#16a34a","growing":"#84cc16","planting":"#84cc16","flowering":"#f59e0b"}
...
export default function HarvestCalendar() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📅 Harvest Calendar</h2>
