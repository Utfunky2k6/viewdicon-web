...
const ITEMS = [
  { name: 'Engine Oil Change - Boat #3', status: 'complete', value: 'Apr 4' },
  { name: 'Hull Repair - Boat #1', status: 'in_progress', value: 'Est. 2 days' },
  { name: 'Net Replacement - Boat #5', status: 'scheduled', value: 'Apr 8' },
  { name: 'Safety Check - All Fleet', status: 'due', value: 'Quarterly - Apr 15' },
]

const SC: Record<string,string> = {"complete":"#16a34a","in_progress":"#f59e0b","scheduled":"#3b82f6","due":"#f59e0b"}

export default function BoatMaintenanceLog() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>⛵ Boat Maintenance Log</h2>
