...
const ITEMS = [
  { name: 'Full Blood Count - PT-401', status: 'processing', value: 'Est. 2hrs' },
  { name: 'Malaria RDT - PT-402', status: 'complete', value: 'Positive' },
  { name: 'Liver Function - PT-403', status: 'pending', value: 'Est. 4hrs' },
  { name: 'Urinalysis - PT-404', status: 'complete', value: 'Normal' },
]

const SC: Record<string,string> = {"processing":"#f59e0b","complete":"#16a34a","pending":"#f59e0b"}

export default function TestRequestSystem() {
  const [selected, setSelected] = useState<number | null>(null)

  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🧪 Test Request System</h2>
