...
const ITEMS = [
  { name: 'Service Due - VH-01', status: 'due', value: '12,500 km reached' },
  { name: 'Insurance Renewal - TR-05', status: 'due', value: 'Expires Apr 20' },
  { name: 'Inspection Passed - VH-02', status: 'complete', value: 'Apr 3' },
  { name: 'Fuel Fill - SV-03', status: 'recorded', value: '45L @ ₡850/L' },
]

const SC: Record<string,string> = {"due":"#f59e0b","complete":"#16a34a","recorded":"#16a34a"}
...
export default function VehicleLog() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🚙 Vehicle Log</h2>
