...
const ITEMS = [
  { name: 'Active Users (24h)', status: 'stat', value: '12,450' },
  { name: 'Transactions Today', status: 'stat', value: '₡45.2M' },
  { name: 'API Response (avg)', status: 'healthy', value: '142ms' },
  { name: 'Error Rate', status: 'healthy', value: '0.03%' },
]

const SC: Record<string,string> = {"stat":"#6366f1","healthy":"#16a34a"}
...
export default function DataDashboard() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📊 Data Dashboard</h2>
