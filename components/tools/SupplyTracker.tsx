...
const ITEMS = [
  { name: 'Surgical Gloves (M)', status: 'adequate', value: '2,400 pairs' },
  { name: 'Syringes 5ml', status: 'low', value: '180 left' },
  { name: 'Gauze Rolls', status: 'adequate', value: '500 rolls' },
  { name: 'IV Fluid (NS)', status: 'critical', value: '24 bags left' },
]
...
export default function SupplyTracker() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>📦 Supply Tracker</h2>
