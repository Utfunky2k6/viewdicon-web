...
const ITEMS = [
  { name: 'Rx #PV-101 - Metformin', status: 'active', value: 'Refills: 3 left' },
  { name: 'Rx #PV-102 - Lisinopril', status: 'active', value: 'Refills: 5 left' },
  { name: 'Rx #PV-103 - Amoxicillin', status: 'expired', value: 'Course completed' },
  { name: 'Rx #PV-104 - Omeprazole', status: 'active', value: 'Refills: 2 left' },
]
...
export default function PrescriptionVault() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>💊 Prescription Vault</h2>
