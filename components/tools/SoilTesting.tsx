...
const ITEMS = [
  { name: 'Plot A - pH Test', status: 'complete', value: 'pH 6.3 (Good)' },
  { name: 'Plot B - Nitrogen', status: 'complete', value: 'Low - fertilize' },
  { name: 'Plot C - Phosphorus', status: 'pending', value: 'Sample sent' },
  { name: 'Plot D - Organic Matter', status: 'complete', value: '3.2% (Adequate)' },
]

const SC: Record<string,string> = {"complete":"#16a34a","pending":"#f59e0b"}
...
export default function SoilTesting() {
  ...
  return (
    <div style={{ padding: 16, fontFamily: 'Inter,system-ui,sans-serif', color: '#1a2e1a' }}>
      <h2 style={{ fontSize: 17, fontWeight: 800, margin: 0, marginBottom: 16 }}>🧪 Soil Testing</h2>
